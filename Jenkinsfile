pipeline {
    ...
    stages {
        ...
        //  sh ''' // sonar-scanner \ // -Dsonar.projectKey=Suivi-Depense-Budget \ //
        ...
        stage('Déploiement Kubernetes') {
            steps {
                withCredentials([file(credentialsId: 'kubeconfig-julo', variable: 'KUBECONFIG_FILE')]) {
                    sh '''
                        ...
                        # Déployer Laravel avec image mise à jour
